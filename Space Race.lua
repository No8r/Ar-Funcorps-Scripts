...
function eventNewPlayer(name)
    player[name] = {jump = nil, fasting = nil}
    TFM.chatMessage("<fc><font color ='#BF4F79'><b>!!سباق الفئران</b></font> مرحبا في \n <font color ='#BF4F79'><b>المسطرة/المسافة</b></font> كل ما عليك فعله هو الضغط على زر \n .لكي تتمكن من الركض و زر السهم الأعلى للقفز  \n\n !!إحذر من أن تقوم بتكسير لوحة المفاتيح و حظا موفقا</fc>", name)
